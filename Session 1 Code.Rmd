...
```{r}
# Let's play around with the `HLA_truncate` function, which is a function from the immunogenetr package. Run the code below, see what happen, and see if you can truncate the allele to one field:
